		...
		<div className={styles.aboutMe}>
			...
			<section className={styles.bio}>
				<span className={styles.bioText}>
					A {currYear - 2005}yo software developer from Brazil with a
					focus on full stack web development and cybersecurity. I
					sometimes participate in CTF events and puzzle hunts with
					friends. Game dev in my free time. Always learning new stuff
